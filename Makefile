...
#    Updated: 2020/07/18 13:43:20 by user42           ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRCS_DISPLAY	=	$(addprefix display/, ft_begin_disp.c ft_close.c ft_start_player.c)

SRCS_NAME		=	cub3d.c ft_init_struct.c $(SRCS_PARSING) $(SRCS_CONVERT) $(SRCS_DISPLAY)
