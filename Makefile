...
#    Updated: 2020/07/24 09:49:02 by user42           ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRCS_DISPLAY	=	$(addprefix display/, ft_begin_disp.c ft_close.c ft_start_player.c ft_loop.c ft_move.c ft_draw.c ft_init.c)
